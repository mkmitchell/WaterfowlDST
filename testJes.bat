...
python runModel.py -w "C:\Workspace\TestDB\TestDB" -g test.gdb -l NWI NWICrossClass.json -p pad -n nced -k kcal.csv -d demand -a SmallTest -b huc -u huc12 name -r urban -f ModelOutputFieldDictionary_test.csv -z debug 1 1 1 1 1 1 1 1